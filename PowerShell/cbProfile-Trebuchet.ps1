#
# Last Modified:  2018 Feb 13 4:12:04 PM
#
...
$pp = select-string -pattern "vim80" -InputObject $env:Path
if(($env:Path | Select-String "vim80") -eq $null) {
...
# gvimr invokes VisStudio, using an existing instance if available
